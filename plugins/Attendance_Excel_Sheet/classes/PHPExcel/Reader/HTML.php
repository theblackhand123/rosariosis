...
//                        }
                        ...
                        if (isset($attributeArray['rowspan']) && isset($attributeArray['colspan'])) {
                            ...
                            foreach (\plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_Cell::extractAllCellReferencesInRange($range) as $value) {
    ...
    public function loadIntoExisting($pFilename, PHPExcel $objPHPExcel)
    {
        ...
        // FJ Fix PHP8.2 deprecated: mb_convert_encoding(): Handling HTML entities via mbstring is deprecated
        // FJ Disable PHP warning "DOMDocument::loadHTML(): Tag [mytag] invalid in Entity"
        libxml_use_internal_errors(true);
        $loaded = $dom->loadHTML(htmlspecialchars_decode(iconv('UTF-8', 'ISO-8859-1', htmlentities($this->securityScanFile($pFilename), ENT_COMPAT, 'UTF-8')), ENT_QUOTES));
        libxml_clear_errors();
        if ($loaded === false) {
