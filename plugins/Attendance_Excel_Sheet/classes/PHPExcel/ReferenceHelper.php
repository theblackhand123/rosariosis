...
class PHPExcel_ReferenceHelper
{
    ...
    protected function adjustPageBreaks(PHPExcel_Worksheet $pSheet, $pBefore, $beforeColumnIndex, $pNumCols, $beforeRow, $pNumRows)
    {
        ...
        ($pNumCols > 0 || $pNumRows > 0) ?
            uksort($aBreaks, array('plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_ReferenceHelper', 'cellReverseSort')) :
            uksort($aBreaks, array('plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_ReferenceHelper', 'cellSort'));
    ...
    protected function adjustHyperlinks($pSheet, $pBefore, $beforeColumnIndex, $pNumCols, $beforeRow, $pNumRows)
    {
        ...
        ($pNumCols > 0 || $pNumRows > 0) ? uksort($aHyperlinkCollection, array('plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_ReferenceHelper', 'cellReverseSort')) : uksort($aHyperlinkCollection, array('plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_ReferenceHelper', 'cellSort'));
    ...
    protected function adjustDataValidations($pSheet, $pBefore, $beforeColumnIndex, $pNumCols, $beforeRow, $pNumRows)
    {
        ...
        ($pNumCols > 0 || $pNumRows > 0) ? uksort($aDataValidationCollection, array('plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_ReferenceHelper', 'cellReverseSort')) : uksort($aDataValidationCollection, array('plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_ReferenceHelper', 'cellSort'));
    ...
    protected function adjustProtectedCells($pSheet, $pBefore, $beforeColumnIndex, $pNumCols, $beforeRow, $pNumRows)
    {
        ...
        ($pNumCols > 0 || $pNumRows > 0) ?
            uksort($aProtectedCells, array('plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_ReferenceHelper', 'cellReverseSort')) :
            uksort($aProtectedCells, array('plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_ReferenceHelper', 'cellSort'));
