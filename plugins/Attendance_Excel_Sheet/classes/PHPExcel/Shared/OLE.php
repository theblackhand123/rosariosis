...
namespace plugins\Attendance_Excel_Sheet\classes\PHPExcel\Shared;

use OLE_PPS_Root;
use PEAR_Error;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Reader\PHPExcel_Reader_Exception;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Shared\OLE\PHPExcel_Shared_OLE_PPS;
...
class PHPExcel_Shared_OLE
{
    ...
    public function getStream($blockIdOrPps)
    {
        ...
        if (!$isRegistered) {
            stream_wrapper_register('ole-chainedblockstream', 'plugins\Attendance_Excel_Sheet\classes\PHPExcel\Shared\OLE\PHPExcel_Shared_OLE_ChainedBlockStream');
            $isRegistered = true;
        }
    ...
    public static function LocalDate2OLE($date = null)
    {
        ...
        for ($i = 0; $i < 4; ++$i) {
            // FJ fix PHP Deprecated Implicit conversion from float
            //$hex = $low_part % 0x100;
