...
namespace plugins\Attendance_Excel_Sheet\classes\PHPExcel\Worksheet;

use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Calculation\PHPExcel_Calculation_DateTime;
...
//                echo 'Value is ', $cellValue,PHP_EOL;
                ...
                $result = $result &&
                    call_user_func_array(
                        array('plugins\Attendance_Excel_Sheet\classes\PHPExcel\Worksheet\PHPExcel_Worksheet_AutoFilter', $columnFilterTest['method']),
