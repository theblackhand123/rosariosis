...
class PHPExcel_Settings
{
    ...
    const PCLZIP = 'plugins\Attendance_Excel_Sheet\classes\PHPExcel\Shared\PHPExcel_Shared_ZipArchive';
    ...
    public static function getLibXmlLoaderOptions()
    {
        ...
        // FJ fix PHP8.1 deprecated passing null to parameter.
        return (int)self::$libXmlLoaderOptions;
    }
}
