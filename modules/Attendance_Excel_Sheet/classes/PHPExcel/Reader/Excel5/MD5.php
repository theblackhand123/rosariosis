...
class PHPExcel_Reader_Excel5_MD5
{
    ...
    public function add($data)
    {
        ...
        $F = array('plugins\Attendance_Excel_Sheet\classes\PHPExcel\Reader\Excel5\PHPExcel_Reader_Excel5_MD5', 'f');
        $G = array('plugins\Attendance_Excel_Sheet\classes\PHPExcel\Reader\Excel5\PHPExcel_Reader_Excel5_MD5', 'g');
        $H = array('plugins\Attendance_Excel_Sheet\classes\PHPExcel\Reader\Excel5\PHPExcel_Reader_Excel5_MD5', 'h');
        $I = array('plugins\Attendance_Excel_Sheet\classes\PHPExcel\Reader\Excel5\PHPExcel_Reader_Excel5_MD5', 'i');
