...
namespace plugins\Attendance_Excel_Sheet\classes\PHPExcel\Reader;

use plugins\Attendance_Excel_Sheet\classes\PHPExcel;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Cell\PHPExcel_Cell_DataType;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Cell\PHPExcel_Cell_DataValidation;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_Cell;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_Exception;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_NamedRange;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_RichText;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_Style;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_Worksheet;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Reader\Excel5\PHPExcel_Reader_Excel5_Color;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Reader\Excel5\PHPExcel_Reader_Excel5_ErrorCode;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Reader\Excel5\PHPExcel_Reader_Excel5_Escher;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Reader\Excel5\PHPExcel_Reader_Excel5_MD5;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Reader\Excel5\PHPExcel_Reader_Excel5_RC4;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Reader\Excel5\Style\PHPExcel_Reader_Excel5_Style_Border;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Reader\Excel5\Style\PHPExcel_Reader_Excel5_Style_FillPattern;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Reader\PHPExcel_Reader_Abstract;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Reader\PHPExcel_Reader_DefaultReadFilter;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Reader\PHPExcel_Reader_Exception;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Reader\PHPExcel_Reader_IReader;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Shared\Escher\DggContainer\BstoreContainer\PHPExcel_Shared_Escher_DggContainer_BstoreContainer_BSE;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Shared\PHPExcel_Shared_CodePage;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Shared\PHPExcel_Shared_Date;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Shared\PHPExcel_Shared_Escher;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Shared\PHPExcel_Shared_Excel5;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Shared\PHPExcel_Shared_OLE;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Shared\PHPExcel_Shared_OLERead;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Shared\PHPExcel_Shared_String;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Style\PHPExcel_Style_Alignment;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Style\PHPExcel_Style_Borders;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Style\PHPExcel_Style_Font;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Style\PHPExcel_Style_NumberFormat;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Style\PHPExcel_Style_Protection;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Worksheet\PHPExcel_Worksheet_Drawing;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Worksheet\PHPExcel_Worksheet_MemoryDrawing;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Worksheet\PHPExcel_Worksheet_PageSetup;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Worksheet\PHPExcel_Worksheet_SheetView;
...
class PHPExcel_Reader_Excel5 extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
    ...
    public function load($pFilename)
    {
        ...
        //$this->xfIndex             = '';
        // FJ fix PHP8.2 Deprecated: Increment on non-alphanumeric string
        $this->xfIndex = 0;
