...
namespace plugins\Attendance_Excel_Sheet\classes\PHPExcel;

use objWorksheet;
use PHPExcel_CachedObjectStorage_xxx;
...
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Cell\PHPExcel_Cell_Hyperlink;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_CachedObjectStorageFactory;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_Calculation;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_Cell;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_Chart;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_Comment;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_Exception;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_IComparable;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_NamedRange;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\PHPExcel_ReferenceHelper;
...
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Shared\PHPExcel_Shared_Font;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Shared\PHPExcel_Shared_PasswordHasher;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Shared\PHPExcel_Shared_String;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Style\PHPExcel_Style_Color;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Style\PHPExcel_Style_Conditional;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Style\PHPExcel_Style_NumberFormat;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Worksheet\PHPExcel_Worksheet_AutoFilter;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Worksheet\PHPExcel_Worksheet_BaseDrawing;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Worksheet\PHPExcel_Worksheet_ColumnDimension;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Worksheet\PHPExcel_Worksheet_ColumnIterator;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Worksheet\PHPExcel_Worksheet_HeaderFooter;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Worksheet\PHPExcel_Worksheet_PageMargins;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Worksheet\PHPExcel_Worksheet_PageSetup;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Worksheet\PHPExcel_Worksheet_Protection;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Worksheet\PHPExcel_Worksheet_RowDimension;
use plugins\Attendance_Excel_Sheet\classes\PHPExcel\Worksheet\PHPExcel_Worksheet_RowIterator;
...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
     ...
     *
     * FJ Fix PHP8.1 Deprecated: Optional parameter declared before required parameter
