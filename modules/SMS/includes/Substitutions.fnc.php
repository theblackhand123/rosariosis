...
if ( ! function_exists( 'SubstitutionsInput' ) )
{
	/**
	 * Substitutions Input
	...
	function SubstitutionsInput( $substitutions )
	{
		...
		$code = ' <input id="substitutions_code_' . $id . '" type="text" readonly size="' . ( strlen( $code_value ) - 1 ) .
			'" value="' . ( function_exists( 'AttrEscape' ) ? AttrEscape( $code_value ) : htmlspecialchars( $code_value, ENT_QUOTES ) ) . '" autocomplete="off" />';

		$copy_button = '<input id="substitutions_button_' . $id . '" type="button" value="' . ( function_exists( 'AttrEscape' ) ? AttrEscape( _( 'Copy' ) ) : htmlspecialchars( _( 'Copy' ), ENT_QUOTES ) ) . '" />';
...
if ( ! function_exists( 'SubstitutionsTextMake' ) )
{
	/**
...
if ( ! function_exists( '_substitutionsDBGetCustomFields' ) )
{
	/**
...
if ( ! function_exists( 'SubstitutionsCustomFields' ) )
{
	/**
...
if ( ! function_exists( 'SubstitutionsCustomFieldsValues' ) )
{
	/**
