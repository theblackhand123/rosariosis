...
namespace plugins\SMS\includes\gateways\includes\africastalking;
use Exeption;
...
class AfricasTalkingGateway
{
    ...
    public function __construct($username_, $apiKey_, $environment_ = "production")
    {
        ...
        // FJ fix for sandbox/test environment.
        $this->_environment = ($username_ === 'sandbox' ? $username_ : $environment_);
