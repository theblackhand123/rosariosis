...
// ESLint directives.
/* global recordrtc, alertDanger, player, playerDOM, startStopBtn, uploadBtn */
/* global recType, maxUploadSize, chunks, blobSize, countdownTicker */
/* exported alertDanger, maxUploadSize, chunks, blobSize */
/* eslint-disable camelcase, no-global-assign */

// JSHint directives.
/* global alertDanger: true, player: true, playerDOM: true, startStopBtn: true */
...
tinymce_recordrtc.view_init = function() {
    ...
    startStopBtn.on('click', function() {
        ...
        if ((startStopBtn.html() === recordrtc.startrecording) ||
            ...
            player.parent().parent().addClass('hide');
            ...
            tinymce_recordrtc.capture_audio(commonConfig);
...
tinymce_recordrtc.capture_audio = function(config) {
